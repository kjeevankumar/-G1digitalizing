...
export default function Hero({ openLegal }) {
  ...
  return (
    <motion.section 
      ...
      className="relative min-h-[100svh] flex items-center pt-24 pb-24 overflow-hidden section-bg-hero"
    >
      ...
      <div className="container mx-auto px-12 w-full relative z-10 max-w-7xl">
        <div className="flex flex-row items-center justify-between gap-16 w-full max-w-7xl mx-auto">
          
          {/* Main Statement Left Side */}
          <div className="w-[55%] text-left flex flex-col items-start">
            <VelocityWrapper maxSkew={6} className="w-full">
              <div className="flex flex-col">
                {/* 1. Speech-like Sequencing - Upgraded to Broadway Scale */}
                <h1 className="text-[clamp(3rem,9vw,6rem)] font-bold leading-[0.92] md:leading-[0.95] tracking-[-0.06em] text-slate-900 pr-4">
                  <motion.span variants={revealVariants(0.5, textDelay1)} initial="hidden" animate="visible" className="block text-slate-400 font-medium text-[clamp(1.75rem,5.5vw,3rem)] mb-4 tracking-[-0.03em]">I’m not here to</motion.span>
                  <motion.span variants={revealVariants(0.6, textDelay2)} initial="hidden" animate="visible" className="flex flex-wrap text-slate-900 drop-shadow-sm">
                ...
                <motion.div variants={revealVariants(0.5, textDelay3)} initial="hidden" animate="visible" className="h-6 md:h-10" />

                <motion.h2 variants={revealVariants(0.6, textDelay3)} initial="hidden" animate="visible" className="text-[clamp(1.75rem,5.5vw,3.25rem)] font-bold text-slate-800 tracking-tight pb-2 lg:pb-3 leading-[1.15]">
                ...
                <motion.p variants={revealVariants(0.5, textDelay4)} initial="hidden" animate="visible" className="mt-5 text-[15px] md:text-[17px] text-slate-500 font-medium leading-relaxed max-w-xl">
                ...
                <motion.p variants={revealVariants(0.5, textDelay4 + 0.3)} initial="hidden" animate="visible" className="mt-10 text-md] text-slate-400 font-bold tracking-widest uppercase flex items-center justify-center lg:justify-start">
          ...
          <motion.div 
            ...
            initial="hidden"
            animate="visible"
            className="w-[40%] max-w-[420px] mx-0 flex flex-col items-start"
          >
            <div className="w-full bg-white/70 backdrop-blur-md p-8 rounded-[2.5rem] border border-white/30 shadow-[0_8px_30px_rgba(0,0,0,0.02),inset_0_1px_0_rgba(255,255,255,0.3)] transition-all duration-700 hover:bg-white/20 hover:shadow-[0_20px_50px_rgba(37,99,235,0.04)] relative group">
              
              <motion.h3 variants={formItemVariants} className="text-slate-800 font-semibold tracking-tight mb-2 text-lg md:text-xl">
                Tell me about your business.
              </motion.h3>
              <motion.p variants={formItemVariants} className="text-slate-500 text-sm mb-8 font-medium">
                Let's discuss your growth goals.
              </motion.p>
              
              <form className="space-y-4 relative z-10 w-full" onSubmit={handleFormSubmit}>
                {/* 5. Input Glow Upgrades with 200ms ease */}
                <motion.div variants={formItemVariants} className="relative group/input">
                  <input type="text" id="name" name="name" required placeholder=" " onChange={handleTyping} className="peer w-full bg-white/20 border border-white/30 shadow-sm rounded-xl px-4 py-4 text-sm font-medium text-slate-800 placeholder-transparent focus:outline-none focus:border-blue-300/60 focus:ring-[2px] focus:ring-blue-400/20 focus:shadow-[0_0_15px_rgba(59,130,246,0.1)] transition-all duration-200 ease-in-out focus:bg-white/70" />
                  <label htmlFor="name" className="absolute left-4 top-4 text-sm font-medium text-slate-400 transition-all duration-200 ease-in-out peer-placeholder-shown:top-4 peer-placeholder-shown:text-sm peer-placeholder-shown:text-slate-400 peer-focus:-top-2.5 peer-focus:left-3 peer-focus:text-[11px] peer-focus:bg-white peer-focus:px-1.5 peer-focus:text-blue-600 peer-focus:rounded-lg peer-valid:-top-2.5 peer-valid:left-3 peer-valid:text-[11px] peer-valid:bg-white peer-valid:px-1.5 peer-valid:text-slate-500 peer-valid:rounded-lg pointer-events-none drop-shadow-sm">Full Name</label>
                </motion.div>

                <motion.div variants={formItemVariants} className="relative group/input">
                  <input type="email" id="email" name="email" required placeholder=" " onChange={handleTyping} className="peer w-full bg-white/20 border border-white/30 shadow-sm rounded-xl px-4 py-4 text-sm font-medium text-slate-800 placeholder-transparent focus:outline-none focus:border-blue-300/60 focus:ring-[2px] focus:ring-blue-400/20 focus:shadow-[0_0_15px_rgba(59,130,246,0.1)] transition-all duration-200 ease-in-out focus:bg-white/70" />
                  <label htmlFor="email" className="absolute left-4 top-4 text-sm font-medium text-slate-400 transition-all duration-200 ease-in-out peer-placeholder-shown:top-4 peer-placeholder-shown:text-sm peer-placeholder-shown:text-slate-400 peer-focus:-top-2.5 peer-focus:left-3 peer-focus:text-[11px] peer-focus:bg-white peer-focus:px-1.5 peer-focus:text-blue-600 peer-focus:rounded-lg peer-valid:-top-2.5 peer-valid:left-3 peer-valid:text-[11px] peer-valid:bg-white peer-valid:px-1.5 peer-valid:text-slate-500 peer-valid:rounded-lg pointer-events-none drop-shadow-sm">Email Address</label>
                </motion.div>
                ...
                <motion.div variants={formItemVariants} className="relative group/input flex gap-2">
                  <div className="relative w-[30%] min-w-[80px]">
                    <select 
                      ...
                      className="w-full bg-white/20 border border-white/30 shadow-sm rounded-xl pl-3 pr-8 py-4 text-sm font-medium text-slate-800 focus:outline-none focus:border-blue-300/60 focus:ring-[2px] focus:ring-blue-400/20 transition-all duration-200 ease-in-out focus:bg-white/70 appearance-none cursor-pointer"
                    >
                  ...
                  <div className="relative w-[70%]">
                    ...
                    <label htmlFor="phone" className="absolute left-4 top-4 text-sm font-medium text-slate-400 transition-all duration-200 ease-in-out peer-placeholder-shown:top-4 peer-placeholder-shown:text-sm peer-placeholder-shown:text-slate-400 peer-focus:-top-2.5 peer-focus:left-3 peer-focus:text-[11px] peer-focus:bg-white peer-focus:px-1.5 peer-focus:text-blue-600 peer-focus:rounded-lg peer-valid:-top-2.5 peer-valid:left-3 peer-valid:text-[11px] peer-valid:bg-white peer-valid:px-1.5 peer-valid:text-slate-500 peer-valid:rounded-lg pointer-events-none drop-shadow-sm">WhatsApp Number</label>
                  </div>
                </motion.div>
                ...
                <motion.div variants={formItemVariants} className="relative group/input">
                  ...
                  <label htmlFor="details" className="absolute left-4 top-4 text-sm font-medium text-slate-400 transition-all duration-200 ease-in-out peer-placeholder-shown:top-4 peer-placeholder-shown:text-sm peer-placeholder-shown:text-slate-400 peer-focus:-top-2.5 peer-focus:left-3 peer-focus:text-[11px] peer-focus:bg-white peer-focus:px-1.5 peer-focus:text-blue-600 peer-focus:rounded-lg peer-valid:-top-2.5 peer-valid:left-3 peer-valid:text-[11px] peer-valid:bg-white peer-valid:px-1.5 peer-valid:text-slate-500 peer-valid:rounded-lg pointer-events-none drop-shadow-sm">Your Project</label>
                </motion.div>
