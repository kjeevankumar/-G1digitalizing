...
export default function AIFeatureHighlight() {
  return (
    <motion.section 
      ...
      id="ai-features" 
      className="py-20 relative overflow-hidden section-bg-ai"
    >
      ...
      <div className="container mx-auto px-12 max-w-7xl relative z-10">
        <div className="flex flex-row items-center gap-20 w-full">
          ...
          >
            <div className="inline-flex py-1 px-4 rounded-full bg-white border border-slate-200/80 text-blue-600 font-bold text-[8px] md:text-[10px] tracking-widest uppercase shadow-sm w-fit mb-8">
              How It Works
            </div>
            
            <h3 className="text-md lg:text-6xl font-bold text-slate-900 leading-tight tracking-tight mb-4">
              Turn your photos <br />
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
              className="text-slate-500/90 text-[15px] md:text-[17px] leading-relaxed font-medium max-w-[400px] mb-7"
            >
          ...
          <div className="w-1/2 flex flex-col relative perspective-[1000px]">
             ...
             <motion.div 
               ...
               className="flex flex-col gap-2 relative z-10 bg-white border border-slate-200/60 shadow-sm p-8 rounded-2xl md:rounded-[2rem] ml-6 md:ml-12"
             >
                <motion.div 
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                  ...
                  viewport={{ once: true }}
                  className="absolute -left-3 md:-left-6 top-1/2 -translate-y-1/2 w-6 h-6 md:w-12 md:h-12 bg-white rounded-full flex items-center justify-center font-bold text-slate-400 border border-slate-200 shadow-[0_2px_10px_rgba(0,0,0,0.06)] text-[8px] md:text-sm"
                >
                  01
                </motion.div>
                <div className="text-slate-400 font-bold uppercase tracking-widest md:tracking-[0.2em] text-[8px] md:text-[10px]">Input</div>
             ...
             <motion.div 
               ...
               className="w-[2px] bg-gradient-to-b from-slate-200 via-blue-300 to-blue-500 ml-10 md:ml-20 relative overflow-hidden" 
             >
                <motion.div 
             ...
             <motion.div 
               ...
               className="flex flex-col gap-1.5 md:gap-3 relative z-20 bg-blue-600 text-white p-8 rounded-2xl md:rounded-[2.5rem] shadow-[0_0_30px_rgba(37,99,235,0.3),0_20px_40px_-5px_rgba(37,99,235,0.4)] border border-blue-400/40 group"
             >
                ...
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  className="absolute -left-4 md:-left-8 top-1/2 -translate-y-1/2 w-8 h-8 md:w-16 md:h-16 bg-blue-700 rounded-full flex items-center justify-center font-bold text-white shadow-[0_4px_15px_rgba(29,78,216,0.5),inset_0_2px_4px_rgba(255,255,255,0.2)] text-[10px] md:text-base z-10"
                >
                  02
                </motion.div>
                <div className="text-blue-200 font-bold uppercase tracking-widest md:tracking-[0.2em] text-[8px] md:text-[10px] pl-2 md:pl-4 relative z-10">Process</div>
                <div className="text-md font-extrabold tracking-tight text-white pl-2 md:pl-4 relative z-10">AI scans photos fast</div>
                
                <motion.div 
                  animate={{ opacity: [0.8, 1, 0.8] }}
                  transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
                  className="bg-blue-700/60 py-2.5 px-5 rounded-lg md:rounded-xl text-[10px] md:text-sm font-medium tracking-wide mt-2 border border-blue-400/30 w-fit drop-shadow-sm ml-2 md:ml-4 flex items-center gap-2 relative z-10"
                >
             ...
             <motion.div 
               ...
               className="w-[2px] bg-gradient-to-b from-blue-500 via-blue-300 to-slate-200 ml-10 md:ml-20 relative overflow-hidden" 
             >
                <motion.div 
                  className="absolute top-0 left-0 w-full h-1/2 bg-white/60 blur-[1px]"
                  animate={{ y: [-24, 48] }}
             ...
             <motion.div 
               ...
               viewport={{ once: true }}
               whileHover={{ scale: 1.02, x: 5, transition: { duration: 0.2 } }}
               className="flex flex-col gap-2 relative z-10 bg-slate-900 text-white border border-slate-800 shadow-[0_10px_30px_rgba(0,0,0,0.1)] p-8 rounded-2xl md:rounded-[2rem] ml-6 md:ml-12"
             >
                <motion.div 
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                  ...
                  viewport={{ once: true }}
                  className="absolute -left-3 md:-left-6 top-1/2 -translate-y-1/2 w-6 h-6 md:w-12 md:h-12 bg-slate-800 rounded-full flex items-center justify-center font-bold text-slate-400 border border-slate-700 shadow-[0_2px_10px_rgba(0,0,0,0.2)] text-[8px] md:text-sm"
                >
                  03
                </motion.div>
                <div className="text-slate-500 font-bold uppercase tracking-widest md:tracking-[0.2em] text-[8px] md:text-[10px]">Output</div>
