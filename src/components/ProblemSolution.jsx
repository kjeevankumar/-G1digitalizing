...
export default function ProblemSolution() {
  ...
  return (
    ...
    <motion.section 
      ...
      className="py-16 md:py-24 relative overflow-hidden section-bg-problem"
    >
      ...
      <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10">
        ...
        >
           ...
           <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold leading-[1.05]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto perspective-[1000px] items-stretch">
          ...
          <TiltCard className="h-full w-full">
            ...
            className="w-full h-full bg-[#fafbfc] border border-slate-200/50 rounded-xl md:rounded-[2.5rem] p-5 sm:p-10 lg:p-12 shadow-[inset_0_4px_20px_rgba(0,0,0,0.02),0_10px_30px_-10px_rgba(0,0,0,0.02)] relative group grayscale-[0.05] flex flex-col justify-center"
          >
            ...
            <div className="text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-widest mb-12 inline-flex items-center gap-3 relative z-10">
            ...
            <ul className="space-y-4 md:space-y-8 relative z-10">
              {problems.map((prob, i) => (
                <motion.li 
                  ...
                  viewport={{ once: true }}
                  className="text-xs sm:text-md lg:text-2xl font-bold text-slate-400/80 tracking-tight flex items-center gap-5"
                >
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="relative z-10 text-[10px] md:text-xs font-bold text-blue-200 uppercase tracking-widest mb-12 flex items-center gap-3">
              ...
              <ul className="space-y-4 md:space-y-8 relative z-10">
                {solutions.map((sol, i) => (
                  <motion.li 
                    ...
                    viewport={{ once: true }}
                    className="text-xs sm:text-md lg:text-2xl font-semibold text-white tracking-tight flex items-center gap-5 drop-shadow-sm"
                  >
                    <motion.div 
        ...
        >
          <p className="text-sm sm:text-md lg:text-lg text-slate-500 font-medium tracking-tight leading-[1.6]">
